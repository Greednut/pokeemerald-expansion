...
enum StringID
{
    ...
    STRINGID_TARGETISBEINGMUDMAELSTORMED,
    STRINGID_TARGETISHURTBYSALTCURE,
    STRINGID_TARGETISHURTBYMUDMAELSTORM,
    ...
    STRINGID_SUPPORTIVENORECOIL,
    STRINGID_TURNABOUT,
    STRINGID_PKMNSTICKYTONGUED,
    STRINGID_STOPSIGNNOPIVOT,
    STRINGID_WEATHERBECAMECLEAR,
    STRINGID_PHANTOMFANGCURSE,
    STRINGID_SHARPENALREADYPUMPED,
    STRINGID_BACKDRAFTALREADYTAILWIND,
    STRINGID_TARGETPURGED,
    STRINGID_INVERTEDAREACREATED,
    STRINGID_INVERSEROOMENDS,
    STRINGID_TYPESBECAMEINVERTED,
    STRINGID_TRANSFUSIONOVER,
    STRINGID_ATTACKERACQUIREDTYPE,
    STRINGID_PKMNSHOTITEM,
    STRINGID_FOUNDAGEM,
    STRINGID_ATTACKERLOSTGRASSTYPE,
    STRINGID_PKMNRAISEDATKPOWER,
    STRINGID_SOULCRUSHED,
    STRINGID_TRICKSTABILLUSIONWOREOFF,
    STRINGID_ATTACKERWASBURIED,
    STRINGID_BURIED,
    STRINGID_PKMNSXRESTOREDPARTNERHPALITTLE2,
    STRINGID_STORMSHELTERACTIVATES,
    STRINGID_ECLIPSEACTIVATES,
    STRINGID_PKMNHURTSWITHREVERSE,
    STRINGID_PKMNSXINFATUATEDYREVERSE,
    STRINGID_TARGETACQUIREDABILITY,
    STRINGID_TARGETWASTRAPPED,
    STRINGID_TEMP_TRAPPED,
    STRINGID_CONCERTDMG,
    STRINGID_UNNERVENOFOOD,
    STRINGID_FLAREHEALHPUP,
    STRINGID_PKMNSITEMPREVENTSYLOSS,
    STRINGID_COLLAPSINGRUINSTEALTHROCKS,
    STRINGID_DEEPBLUE,
    STRINGID_DEADSILENCE,
    STRINGID_ENHANCEDFIREORBS,
    STRINGID_COUNT
};
