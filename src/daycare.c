...
} sBreedingSpecialMoveItemTable[] =
{
    ...
    { SPECIES_GARGARRAMER, ITEM_FLYING_GEM, MOVE_HURRICANE }, 
    { SPECIES_SKALLAXY, ITEM_SUN_STONE, MOVE_SONIC_BOOM }, /////
    { SPECIES_GUERTENITY, ITEM_POKE_DOLL, MOVE_MEAN_LOOK },
    ...
    { SPECIES_STRIXNIGHT, ITEM_MIND_PLATE , MOVE_FREEZING_GLARE },   // New Move
    { SPECIES_MOGUMOLE, ITEM_RAZOR_CLAW , MOVE_DRAGON_HAMMER }, 
    { SPECIES_NAUGHTYCOOT, ITEM_SITRUS_BERRY , MOVE_GRAV_APPLE }, 
    ...
    { SPECIES_CHOLEFIR, ITEM_SNOWBALL, MOVE_CAMOUFLAGE },
    ...
    { SPECIES_BARABYSS, ITEM_DRAGON_SCALE, MOVE_DRAGON_DANCE },
    ...
    { SPECIES_KRACKODEMON, ITEM_STICKY_BARB, MOVE_SPIKY_SHIELD },
    ...
    { SPECIES_ANKHURAH, ITEM_RARE_BONE , MOVE_WISH },
    { SPECIES_PHAMOTHOM, ITEM_BRIGHT_POWDER, MOVE_BLUE_FLARE },  
    { SPECIES_PERMACEROS, ITEM_SOFT_SAND, MOVE_THOUSAND_WAVES },
    ...
    { SPECIES_KAQUAPO, ITEM_SEA_INCENSE, MOVE_CELEBRATE }, ///PLACEHOLDER ITEM
    ...
    { SPECIES_BRAXITYTAN, ITEM_BRIGHT_POWDER, MOVE_SPOTLIGHT },
    ...
    { SPECIES_LUNABBIT, ITEM_FOCUS_BAND, MOVE_JUMP_KICK }, 
    { SPECIES_SIMIONACH, ITEM_WISE_GLASSES, MOVE_PSYSTRIKE }, 
    { SPECIES_HORNTUBA, ITEM_THROAT_SPRAY, MOVE_PARTING_SHOT },
    { SPECIES_CARPEDIAN, ITEM_DRAGON_SCALE, MOVE_DRAGON_DANCE },  
    { SPECIES_WHIPSICUFFS, ITEM_ASSAULT_VEST, MOVE_DEFEND_ORDER },  
    { SPECIES_DISBEARY, ITEM_SPELL_TAG, MOVE_GRUDGE },
    { SPECIES_COSTRIKE, ITEM_ROCK_GEM, MOVE_METEOR_ASSAULT },
    { SPECIES_GINOCCHIO, ITEM_STICKY_BARB, MOVE_SPIKE_CANNON },
    { SPECIES_SALEZERKER, ITEM_LEFTOVERS, MOVE_BELLY_DRUM },
    { SPECIES_LEMIRETHUN, ITEM_WATER_GEM, MOVE_RELIC_SONG },
    ...
    { SPECIES_COCKEN, ITEM_NEVER_MELT_ICE, MOVE_SHEER_COLD },
    { SPECIES_PRIMITEVE, ITEM_RING_TARGET, MOVE_THOUSAND_ARROWS },
    { SPECIES_MOLTERRA, ITEM_SACRED_ASH, MOVE_CRITICAL_MASS },
    { SPECIES_DRAKLOWN, ITEM_CHARCOAL, MOVE_INFERNO },
    { SPECIES_ZILLICHINA, ITEM_NEVER_MELT_ICE, MOVE_SHEER_COLD },
    { SPECIES_HYBROTAMUS, ITEM_CARBOS, MOVE_BURN_UP },
    { SPECIES_JERMIN, ITEM_SILK_SCARF, MOVE_HEAD_CHARGE },
    { SPECIES_SKUBMARINE_ANTI, ITEM_CELL_BATTERY, MOVE_DISCHARGE },
    { SPECIES_SKUBMARINE_PRO, ITEM_CHARCOAL, MOVE_FLARE_BLITZ },
    { SPECIES_CAMELODUCTOR, ITEM_CALCIUM, MOVE_THUNDER_CAGE },
    ...
    { SPECIES_FUSJAHL, ITEM_METRONOME, MOVE_TRIPLE_AXEL },
    { SPECIES_EMEFFYUME, ITEM_SACRED_ASH, MOVE_SACRED_FIRE },
    { SPECIES_MAMMOUNT, ITEM_NEVER_MELT_ICE, MOVE_GLACIAL_LANCE}, 
    ...
    { SPECIES_TERMAGNIUS, ITEM_DRAGON_GEM, MOVE_SPACIAL_REND },
    { SPECIES_DOOMSAY, ITEM_METAL_COAT, MOVE_GUILLOTINE}, //Whetstone
    { SPECIES_AMPSTAR, ITEM_LIGHT_BALL, MOVE_ENCORE }, // Replace with Microphone once implemented
    { SPECIES_CROLORD, ITEM_POWER_HERB, MOVE_SKY_ATTACK },
    { SPECIES_DREDALISK, ITEM_SHARP_BEAK, MOVE_SKY_ATTACK },
    { SPECIES_KUMATARO, ITEM_STARDUST, MOVE_ROAR_OF_TIME },
    { SPECIES_APOCAMISE, ITEM_DUSK_BALL, MOVE_HYPERSPACE_FURY },
    { SPECIES_AQUADIIVA, ITEM_KINGS_ROCK, MOVE_KINGS_SHIELD },
