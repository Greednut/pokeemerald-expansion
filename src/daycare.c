...
} sBreedingSpecialMoveItemTable[] =
{
    ...
    { SPECIES_MANTASM, ITEM_PRETTY_FEATHER, MOVE_SKY_ATTACK },
    ...
    { SPECIES_GAROOKIE, ITEM_FLYING_GEM, MOVE_HURRICANE }, 
    { SPECIES_BORKOSMOS, ITEM_SUN_STONE, MOVE_SONIC_BOOM }, /////
    { SPECIES_FABRINNIAL, ITEM_POKE_DOLL, MOVE_MEAN_LOOK },
    { SPECIES_TOWHORSE, ITEM_ORAN_BERRY, MOVE_LICK },
    { SPECIES_ORYUGAMI, ITEM_SHARP_BEAK, MOVE_DRILL_PECK },
    { SPECIES_HOOKLING, ITEM_RED_CARD, MOVE_TRUMP_CARD },
    { SPECIES_WINKHULU, ITEM_ZOOM_LENS, MOVE_FREEZING_GLARE },
    { SPECIES_MOYALITH, ITEM_KINGS_ROCK , MOVE_PRECIPICE_BLADES },  
    { SPECIES_GANGLYTHON, ITEM_TWISTED_SPOON , MOVE_KINESIS },
    { SPECIES_STOWLET, ITEM_PSYCHIC_GEM , MOVE_FREEZING_GLARE },   // New Move
    { SPECIES_MOGUMOLE, ITEM_RAZOR_CLAW , MOVE_DRAGON_HAMMER }, 
    { SPECIES_BANDICUTE, ITEM_SITRUS_BERRY , MOVE_GRAV_APPLE }, 
    { SPECIES_TRIDERLING, ITEM_HARD_STONE , MOVE_ROCK_BLAST },
    { SPECIES_VRISKELETON, ITEM_METRONOME , MOVE_ENCORE },  
    { SPECIES_SHROOMAG, ITEM_MIRACLE_SEED , MOVE_SUNSTEEL_STRIKE },
    { SPECIES_FLEURRIUM, ITEM_WHETSTONE , MOVE_MEMENTO }, 
    { SPECIES_VANITWIN, ITEM_SPELL_TAG , MOVE_SPECTRAL_THIEF },
    { SPECIES_YARDSTEIN, ITEM_CELL_BATTERY , MOVE_FINAL_GAMBIT }, 
    { SPECIES_MONKITE, ITEM_PROTECTIVE_PADS , MOVE_DARKEST_LARIAT },
    { SPECIES_LARVATRICE, ITEM_DRAGON_FANG, MOVE_DRAGON_DARTS }, 
    { SPECIES_DISPLACERK, ITEM_SPELL_TAG , MOVE_SPIRIT_SHACKLE },  
    { SPECIES_FLORIBEL, ITEM_GRASSY_SEED , MOVE_SLEEP_POWDER },  
    { SPECIES_COFFERULE, ITEM_QUICK_CLAW , MOVE_ACCELEROCK },
    { SPECIES_FRIJOLERO, ITEM_CHARCOAL , MOVE_INFERNO },   
    { SPECIES_JUANKEY, ITEM_LIGHT_BALL , MOVE_VOLT_TACKLE },  
    { SPECIES_KIWI, ITEM_MIRACLE_SEED , MOVE_JUNGLE_HEALING },
    { SPECIES_LARVITTY, ITEM_DUSK_BALL, MOVE_SHADOW_FORCE },
    { SPECIES_PASCAL, ITEM_LUXURY_BALL , MOVE_SPIRIT_BREAK },
    { SPECIES_BURNUGGET, ITEM_AIR_BALLOON, MOVE_HIGH_JUMP_KICK },
    { SPECIES_DIRTYBIS, ITEM_SHARP_BEAK, MOVE_BEAK_BLAST },
    { SPECIES_TURTINI, ITEM_ZOOM_LENS, MOVE_INSTRUCT }, 
    { SPECIES_VINEDUP, ITEM_FLAME_ORB , MOVE_BURN_UP },
    { SPECIES_POLTIRE, ITEM_METAL_COAT , MOVE_METEOR_MASH },
    { SPECIES_HELMATA, ITEM_EJECT_BUTTON , MOVE_PUNCH_OUT },
    { SPECIES_CAMEREX, ITEM_CELL_BATTERY , MOVE_ZING_ZAP },
    { SPECIES_TAMANAUT, ITEM_MENTAL_HERB , MOVE_HEART_SWAP },
    { SPECIES_SHROOMALICE, ITEM_RING_TARGET , MOVE_HYPERSPACE_HOLE },
    { SPECIES_DOGAN, ITEM_FOCUS_SASH, MOVE_CLOSE_COMBAT },
    { SPECIES_BUBBASAUR, ITEM_LUCKY_EGG , MOVE_BELLY_DRUM },
    { SPECIES_SPORESTOOL, ITEM_LOVE_BALL , MOVE_PLAY_ROUGH },
    { SPECIES_ULMIRAINT, ITEM_CELL_BATTERY , MOVE_ZAP_CANNON },
    { SPECIES_KRAMBERRY, ITEM_NEVER_MELT_ICE , MOVE_GLACIATE },
    { SPECIES_BAMBUYA, ITEM_ORAN_BERRY , MOVE_NATURES_MADNESS },
    { SPECIES_JUMBLEGORE, ITEM_AWAKENING , MOVE_MIND_BLOWN },
    { SPECIES_JUMBLINART, ITEM_PARALYZE_HEAL , MOVE_ORIGIN_PULSE }, ///placeholder
    { SPECIES_ARCRIDGET, ITEM_OCCA_BERRY , MOVE_AXE_KICK },   
    { SPECIES_PEGUI, ITEM_SHARP_BEAK, MOVE_BRAVE_BIRD },
    { SPECIES_WYCERN, ITEM_FIRE_GEM, MOVE_ICE_BURN },
    { SPECIES_FIRVID, ITEM_SNOWBALL, MOVE_CAMOUFLAGE },
    { SPECIES_SPARMOR, ITEM_CELL_BATTERY, MOVE_VOLT_TACKLE },
    { SPECIES_OUROBLACK, ITEM_MOON_STONE, MOVE_ROAR_OF_TIME },
    { SPECIES_EMOJINN, ITEM_WELLSPRING_MASK, MOVE_PHOTON_GEYSER }, //Replace with Lucky Lamp when added
    { SPECIES_VOLTOCOR, ITEM_ELECTRIC_SEED, MOVE_BOLT_STRIKE },
    { SPECIES_SEAMAN, ITEM_DRAGON_SCALE, MOVE_DRAGON_DANCE },
    { SPECIES_STROLLGE, ITEM_BLACK_GLASSES, MOVE_TRANSFORM },
    { SPECIES_PEDESTONE, ITEM_HARD_STONE, MOVE_ROCK_WRECKER },
    { SPECIES_IMPFECTION, ITEM_LOADED_DICE, MOVE_HEART_SWAP },
    { SPECIES_HYDUCK, ITEM_MOON_STONE, MOVE_LUNAR_DANCE },
    { SPECIES_KRISSY, ITEM_STICKY_BARB, MOVE_SPIKY_SHIELD },
    { SPECIES_INKROW, ITEM_SMOKE_BALL, MOVE_GASTRO_ACID }, /// STERILIZING AMPOULE
    { SPECIES_MEOWER, ITEM_MENTAL_HERB, MOVE_FLOWER_SHIELD },  
    { SPECIES_MOBLIN, ITEM_CHOICE_BAND, MOVE_DRAGON_HAMMER },  
    { SPECIES_SCHIZSTARF, ITEM_STARF_BERRY, MOVE_JUNGLE_HEALING },
    { SPECIES_WAWHO, ITEM_NUGGET, MOVE_MEMENTO },
    { SPECIES_MAGGHOST, ITEM_BRIGHT_POWDER, MOVE_BLUE_FLARE },  
    { SPECIES_SUBSTRALE, ITEM_SOFT_SAND, MOVE_THOUSAND_WAVES },
    { SPECIES_SWINGGLE, ITEM_STICKY_BARB, MOVE_STICKY_WEB },
    { SPECIES_TRIACTITE, ITEM_HARD_STONE, MOVE_ROCK_WRECKER }, /// Placeholder Move
    { SPECIES_SYCOSECT, ITEM_FIRE_GEM, MOVE_MYSTICAL_FIRE },
    { SPECIES_MEDUSITH, ITEM_PSYCHIC_GEM, MOVE_SYNCHRONOISE },
    { SPECIES_AIRUITE, ITEM_SEA_INCENSE, MOVE_CELEBRATE }, ///PLACEHOLDER ITEM
    { SPECIES_ONUSALT, ITEM_POISON_BARB, MOVE_VENOM_DRENCH },
    { SPECIES_LOBER, ITEM_GRIP_CLAW, MOVE_CRUSH_GRIP },
    { SPECIES_SPIRANHA, ITEM_ROCK_GEM, MOVE_HEAD_SMASH },  
    { SPECIES_MEATIER, ITEM_BRIGHT_POWDER, MOVE_SPOTLIGHT },
    { SPECIES_ENVILE, ITEM_SHED_SHELL, MOVE_JAW_LOCK },
    { SPECIES_FLOCKARRION, ITEM_DESTINY_KNOT, MOVE_PERISH_SONG },
    { SPECIES_WEATHERBANE, ITEM_WACAN_BERRY, MOVE_GUILLOTINE }, 
    { SPECIES_CYCLONIAN, ITEM_CELL_BATTERY, MOVE_SHIFT_GEAR },
    { SPECIES_SQUITHEE, ITEM_BLACK_BELT , MOVE_CLOSE_COMBAT },
    { SPECIES_ANKHIRA, ITEM_RARE_BONE , MOVE_WISH },
    { SPECIES_DUBSNAKE, ITEM_BLACK_SLUDGE, MOVE_RECOVER }, 
    { SPECIES_EPIPHEROR, ITEM_STAR_PIECE, MOVE_METEOR_MASH },
    ...
    { SPECIES_TOKOYAKI, ITEM_ROCK_INCENSE, MOVE_SHORE_UP }, 
    { SPECIES_PEASOL, ITEM_NORMAL_GEM, MOVE_LAST_RESORT },
    { SPECIES_FLUBUNNY, ITEM_LAX_INCENSE, MOVE_EERIE_SPELL },
    { SPECIES_TADPOISON, ITEM_SMOKE_BALL , MOVE_CLEAR_SMOG },
    { SPECIES_SIMIONACH, ITEM_WISE_GLASSES, MOVE_PSYSTRIKE }, 
    { SPECIES_DOOMTER, ITEM_THROAT_SPRAY, MOVE_PARTING_SHOT },
    { SPECIES_FRYZZLE, ITEM_DRAGON_SCALE, MOVE_DRAGON_DANCE },  
    { SPECIES_WHIMPLE, ITEM_ASSAULT_VEST, MOVE_DEFEND_ORDER },  
    { SPECIES_AFLOOF, ITEM_SPELL_TAG, MOVE_GRUDGE },
    { SPECIES_SPHARE, ITEM_ROCK_GEM, MOVE_METEOR_ASSAULT },
    { SPECIES_MAPLAGE, ITEM_STICKY_BARB, MOVE_SPIKE_CANNON },
    { SPECIES_MAGMATA, ITEM_LEFTOVERS, MOVE_BELLY_DRUM },
    { SPECIES_FRUDGE, ITEM_WATER_GEM, MOVE_RELIC_SONG },
    { SPECIES_BUGGY, ITEM_METAL_COAT, MOVE_GEAR_UP },
    { SPECIES_ARACHNOTE, ITEM_METRONOME, MOVE_RELIC_SONG }, 
    { SPECIES_SANICKEL, ITEM_SODA_POP, MOVE_BELCH }, 
    { SPECIES_ROOTCHEW, ITEM_BIG_ROOT, MOVE_LANDS_WRATH }, 
    { SPECIES_WATTITUDE, ITEM_ZOOM_LENS , MOVE_ELECTRO_BALL },
    { SPECIES_ICEHUGGER, ITEM_WISE_GLASSES, MOVE_LOCK_ON },
    { SPECIES_INDIGNIFLY, ITEM_ODD_INCENSE, MOVE_WISH },
    { SPECIES_VANITWIN, ITEM_KASIB_BERRY, MOVE_ASTRAL_BARRAGE },
    { SPECIES_DINOMIGHT, ITEM_NEVER_MELT_ICE, MOVE_SHEER_COLD },
    { SPECIES_PRIMITOOL, ITEM_RING_TARGET, MOVE_THOUSAND_ARROWS },
    { SPECIES_MOLTAMA, ITEM_SACRED_ASH, MOVE_CRITICAL_MASS },
    { SPECIES_FETTORCH, ITEM_BINDING_BAND, MOVE_BIND },
    { SPECIES_TRICKLING, ITEM_CHARCOAL, MOVE_INFERNO },
    { SPECIES_DRATTEL, ITEM_NEVER_MELT_ICE, MOVE_SHEER_COLD },
    { SPECIES_COMMUTANT, ITEM_CARBOS, MOVE_BURN_UP },
    { SPECIES_JERMIN, ITEM_SILK_SCARF, MOVE_HEAD_CHARGE },
    { SPECIES_SKUBA_ANTI, ITEM_CELL_BATTERY, MOVE_DISCHARGE },
    { SPECIES_SKUBA_PRO, ITEM_CHARCOAL, MOVE_FLARE_BLITZ },
    { SPECIES_CATOBIRRAFE, ITEM_CALCIUM, MOVE_THUNDER_CAGE },
    { SPECIES_RENDALOPOD, ITEM_DARK_GEM, MOVE_OVERBITE },  
    { SPECIES_SACCESTODA, ITEM_LEPPA_BERRY, MOVE_MIST_BALL },
    { SPECIES_GLUCURS, ITEM_HARD_STONE, MOVE_METEOR_ASSAULT },
    { SPECIES_AMALGUM, ITEM_SACRED_ASH, MOVE_FLEUR_CANNON },
    { SPECIES_VORTRIX, ITEM_BRIGHT_POWDER, MOVE_TOXIC_THREAD },
    { SPECIES_JAHL, ITEM_METRONOME, MOVE_TRIPLE_AXEL },
    { SPECIES_EPILATE, ITEM_WIDE_LENS, MOVE_FREEZING_GLARE },
    { SPECIES_QRAKENMARK, ITEM_DESTINY_KNOT, MOVE_LOVELY_KISS },
    { SPECIES_EMEFFYUME, ITEM_SACRED_ASH, MOVE_SACRED_FIRE },
    { SPECIES_MAMINI, ITEM_NEVER_MELT_ICE, MOVE_GLACIAL_LANCE}, 
    { SPECIES_KNITTEN, ITEM_DESTINY_KNOT, MOVE_YAWN },
    { SPECIES_PARMIAUSAN, ITEM_LEFTOVERS, MOVE_MINIMIZE },
    { SPECIES_PIURETTE, ITEM_HEAT_ROCK, MOVE_MYSTICAL_FIRE },
    { SPECIES_KLASICOPE, ITEM_DRAGON_GEM, MOVE_SPACIAL_REND },
    { SPECIES_DOOMSAY, ITEM_WHETSTONE, MOVE_GUILLOTINE}, 
    { SPECIES_HAMSTATIC, ITEM_MICROPHONE, MOVE_ENCORE }, 
    { SPECIES_CROLORD, ITEM_POWER_HERB, MOVE_SKY_ATTACK },
    { SPECIES_JARUMITE, ITEM_DRAGON_SCALE, MOVE_DRAGON_ASCENT },
    { SPECIES_DREDALISK, ITEM_SHARP_BEAK, MOVE_SKY_ATTACK },
    { SPECIES_BEAREDAZE, ITEM_STARDUST, MOVE_ROAR_OF_TIME },
    { SPECIES_VENIREAL, ITEM_DUSK_BALL, MOVE_HYPERSPACE_FURY },
    { SPECIES_YUUKIINO, ITEM_KINGS_ROCK, MOVE_KINGS_SHIELD },
    { SPECIES_ESCARPHONE, ITEM_METRONOME , MOVE_PSYCHIC_NOISE }, 
    { SPECIES_OBSERVEDA, ITEM_CELL_BATTERY , MOVE_ELECTRO_SHOT },
    { SPECIES_KURILTY, ITEM_DAMP_ROCK , MOVE_TRIPLE_DIVE },
    { SPECIES_VELVERNEAN, ITEM_RAWST_BERRY , MOVE_RAGING_FURY },
    { SPECIES_CHALLIOPE, ITEM_DESTINY_KNOT , MOVE_POPULATION_BOMB },
    { SPECIES_ALCLIONE, ITEM_DUSK_STONE , MOVE_COMEUPPANCE },
