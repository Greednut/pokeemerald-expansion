...
} sBreedingSpecialMoveItemTable[] =
{
    ...
    { SPECIES_STOWLET, ITEM_MIND_PLATE , MOVE_FREEZING_GLARE },   // New Move
    ...
    { SPECIES_FLEURRIUM, ITEM_GRIP_CLAW , MOVE_MEMENTO }, /////// WHETSTONE
    ...
    { SPECIES_LARVATRICE, ITEM_DRAGON_FANG, MOVE_DRAGON_ENERGY }, 
    ...
    { SPECIES_SYCOSECT, ITEM_MOLUGANION, MOVE_STRENGTH_SAP }, /// Placeholder Item
    ...
    { SPECIES_HAARSHOGUN, ITEM_NORMAL_GEM, MOVE_LAST_RESORT },
    { SPECIES_FLUBUNNY, ITEM_FOCUS_BAND, MOVE_JUMP_KICK }, 
    ...
    { SPECIES_DOOMSAY, ITEM_METAL_COAT, MOVE_GUILLOTINE}, //Whetstone
    { SPECIES_HAMSTATIC, ITEM_LIGHT_BALL, MOVE_ENCORE }, // Replace with Microphone once implemented
