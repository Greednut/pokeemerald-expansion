...
PLACEHOLDER_ANIM_SINGLE_FRAME(Merulin);
SINGLE_ANIMATION(Merulin);

PLACEHOLDER_ANIM_SINGLE_FRAME(Arcridget);
SINGLE_ANIMATION(Arcridget);

PLACEHOLDER_ANIM_SINGLE_FRAME(Escarphone);
SINGLE_ANIMATION(Escarphone);

PLACEHOLDER_ANIM_SINGLE_FRAME(UlmiraintAutumn);
SINGLE_ANIMATION(UlmiraintAutumn);

PLACEHOLDER_ANIM_SINGLE_FRAME(Observeda);
SINGLE_ANIMATION(Observeda);

PLACEHOLDER_ANIM_SINGLE_FRAME(Kurilty);
SINGLE_ANIMATION(Kurilty);

PLACEHOLDER_ANIM_SINGLE_FRAME(Velvernean);
SINGLE_ANIMATION(Velvernean);

PLACEHOLDER_ANIM_SINGLE_FRAME(Challiope);
SINGLE_ANIMATION(Challiope);

PLACEHOLDER_ANIM_SINGLE_FRAME(Alclione);
SINGLE_ANIMATION(Alclione);
