...
static const struct FormChange sGargarramerFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_BEFORE_MOVE_CATEGORY, SPECIES_GARGARRAMER_AWAKEN, DAMAGE_CATEGORY_PHYSICAL, ABILITY_STONEFLESH},
    {FORM_CHANGE_BATTLE_BEFORE_MOVE_CATEGORY, SPECIES_GARGARRAMER_AWAKEN, DAMAGE_CATEGORY_SPECIAL,  ABILITY_STONEFLESH},
    {FORM_CHANGE_BATTLE_BEFORE_MOVE,          SPECIES_GARGARRAMER_ASLEEP, MOVE_PETRIFY,             ABILITY_STONEFLESH},
    {FORM_CHANGE_BATTLE_SWITCH,               SPECIES_GARGARRAMER_ASLEEP},
    {FORM_CHANGE_FAINT,                       SPECIES_GARGARRAMER_ASLEEP},
    {FORM_CHANGE_END_BATTLE,                  SPECIES_GARGARRAMER_ASLEEP},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sJerminFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_HP_PERCENT, SPECIES_JERMIN_SWARM, ABILITY_SWARMING, HP_HIGHER_THAN,   25},
    {FORM_CHANGE_BATTLE_HP_PERCENT, SPECIES_JERMIN_SOLO,   ABILITY_SWARMING, HP_LOWER_EQ_THAN, 25},
    {FORM_CHANGE_BATTLE_SWITCH,     SPECIES_JERMIN_SOLO},
    {FORM_CHANGE_FAINT,             SPECIES_JERMIN_SOLO},
...
static const struct FormChange sArctiglobeFormChangeTable[] = {
    {FORM_CHANGE_HIT_BY_SUPER_EFFECTIVE_MOVE,             SPECIES_ARCTIGLOBE_FREED},
    {FORM_CHANGE_FAINT,             SPECIES_ARCTIGLOBE},
    {FORM_CHANGE_END_BATTLE,        SPECIES_ARCTIGLOBE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ARCTIGLOBE_ENCASED, ITEM_NONE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ARCTIGLOBE_FREED, ITEM_SUBLIME_KEY},
    {FORM_CHANGE_TERMINATOR},
};
static const struct FormChange sDisbearyFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_TURN_END,   SPECIES_DISBEARY_EBIL,     ABILITY_TEMPERAMENTAL},
    {FORM_CHANGE_BATTLE_TURN_END,   SPECIES_DISBEARY_NICE,     ABILITY_TEMPERAMENTAL},
    {FORM_CHANGE_BATTLE_SWITCH,     SPECIES_DISBEARY_NICE},
    {FORM_CHANGE_FAINT,             SPECIES_DISBEARY_NICE},
    {FORM_CHANGE_END_BATTLE,        SPECIES_DISBEARY_NICE},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sUlmiraintFormChangeTable[] = {
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ULMIRAINT_NORMAL,   ITEM_NONE,         ABILITY_PALLETE_SWAP},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ULMIRAINT_GRASS,    ITEM_PHTHALO_GREEN_PAINT, ABILITY_PALLETE_SWAP},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ULMIRAINT_DARK,     ITEM_CARBON_BLACK_PAINT, ABILITY_PALLETE_SWAP},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ULMIRAINT_STEEL,   ITEM_LEAD_WHITE_PAINT, ABILITY_PALLETE_SWAP},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ULMIRAINT_DRAGON,   ITEM_ULTRAMARINE_PAINT, ABILITY_PALLETE_SWAP},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ULMIRAINT_ICE,   ITEM_TITANIUM_WHITE_PAINT, ABILITY_PALLETE_SWAP},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ULMIRAINT_GHOST,   ITEM_COBALT_VIOLET_PAINT, ABILITY_PALLETE_SWAP},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ULMIRAINT_PSYCHIC,   ITEM_QUINACRIDONE_PAINT, ABILITY_PALLETE_SWAP},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ULMIRAINT_POISON,   ITEM_HELIOTROPE_PAINT, ABILITY_PALLETE_SWAP},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ULMIRAINT_FIGHTING,   ITEM_BURNT_SIENNA_PAINT, ABILITY_PALLETE_SWAP},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ULMIRAINT_FAIRY,   ITEM_POTER_PINK_PAINT, ABILITY_PALLETE_SWAP},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ULMIRAINT_GROUND,   ITEM_UMBER_PAINT, ABILITY_PALLETE_SWAP},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ULMIRAINT_ROCK,   ITEM_YELLOW_OCHRE_PAINT, ABILITY_PALLETE_SWAP},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ULMIRAINT_FLYING,   ITEM_CERULEAN_BLUE_PAINT, ABILITY_PALLETE_SWAP},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ULMIRAINT_BUG,   ITEM_MALACHITE_PAINT, ABILITY_PALLETE_SWAP},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ULMIRAINT_ELECTRIC,   ITEM_HANSA_YELLOW_PAINT, ABILITY_PALLETE_SWAP},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ULMIRAINT_WATER,   ITEM_AZUMARITE_PAINT, ABILITY_PALLETE_SWAP},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ULMIRAINT_FIRE,   ITEM_PYRROLE_ORANGE_PAINT, ABILITY_PALLETE_SWAP},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ULMIRAINT_AUTUMN,   ITEM_MEADOW_PLATE, ABILITY_PALLETE_SWAP},
    {FORM_CHANGE_TERMINATOR},
};
static const struct FormChange sSimionachFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_HP_PERCENT, SPECIES_SIMIONACH_UNFOCUSED, ABILITY_ZEN_MONKEY, HP_HIGHER_THAN,   99},
    {FORM_CHANGE_BATTLE_HP_PERCENT, SPECIES_SIMIONACH_ZEN,       ABILITY_ZEN_MONKEY, HP_LOWER_EQ_THAN, 99},
    {FORM_CHANGE_FAINT,             SPECIES_SIMIONACH_UNFOCUSED},
...
static const struct FormChange sEmojinnFormChangeTable[] = {
    ...
    {FORM_CHANGE_ITEM_HOLD,               SPECIES_EMOJINN_SOBBING,       ITEM_SOBBING_MASK},
...
static const struct FormChange sShiribikoFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_TURN_END,          SPECIES_SHIRIBIKO_ULTRA, ABILITY_ULTRAPOSITION},
    {FORM_CHANGE_FAINT,                       SPECIES_SHIRIBIKO_PLAYING},
    {FORM_CHANGE_END_BATTLE,                  SPECIES_SHIRIBIKO_PLAYING},
    {FORM_CHANGE_TERMINATOR},
};
static const struct FormChange sPolybrawnFormChangeTable[] = {
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_POLYBRAWN,     ITEM_BROKEN_CONTROLLER, 0},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_POLYBRAWN_H,   ITEM_BROKEN_CONTROLLER, 1},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_POLYBRAWN_W,   ITEM_BROKEN_CONTROLLER, 2},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_POLYBRAWN_I,   ITEM_BROKEN_CONTROLLER, 3},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_POLYBRAWN_P,   ITEM_BROKEN_CONTROLLER, 4},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_POLYBRAWN_K,   ITEM_BROKEN_CONTROLLER, 5},
    {FORM_CHANGE_TERMINATOR},
};
#undef WHEN_LEARNED
