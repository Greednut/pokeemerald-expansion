...
static const struct FormChange sUlmiraintFormChangeTable[] = {
    ...
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ULMIRAINT_GRASS,    ITEM_MEADOW_PLATE, ABILITY_PALLETE_SWAP},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ULMIRAINT_DARK,     ITEM_DREAD_PLATE, ABILITY_PALLETE_SWAP},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ULMIRAINT_STEEL,   ITEM_LEAD_WHITE_PAINT, ABILITY_PALLETE_SWAP},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ULMIRAINT_DRAGON,   ITEM_DRACO_PLATE, ABILITY_PALLETE_SWAP},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ULMIRAINT_ICE,   ITEM_ICICLE_PLATE, ABILITY_PALLETE_SWAP},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ULMIRAINT_GHOST,   ITEM_COBALT_VIOLET_PAINT, ABILITY_PALLETE_SWAP},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ULMIRAINT_PSYCHIC,   ITEM_MIND_PLATE, ABILITY_PALLETE_SWAP},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ULMIRAINT_POISON,   ITEM_TOXIC_PLATE, ABILITY_PALLETE_SWAP},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ULMIRAINT_FIGHTING,   ITEM_FIST_PLATE, ABILITY_PALLETE_SWAP},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ULMIRAINT_FAIRY,   ITEM_POTER_PINK_PAINT, ABILITY_PALLETE_SWAP},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ULMIRAINT_GROUND,   ITEM_EARTH_PLATE, ABILITY_PALLETE_SWAP},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ULMIRAINT_ROCK,   ITEM_STONE_PLATE, ABILITY_PALLETE_SWAP},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ULMIRAINT_FLYING,   ITEM_SKY_PLATE, ABILITY_PALLETE_SWAP},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ULMIRAINT_BUG,   ITEM_MALACHITE_PAINT, ABILITY_PALLETE_SWAP},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ULMIRAINT_ELECTRIC,   ITEM_ZAP_PLATE, ABILITY_PALLETE_SWAP},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ULMIRAINT_WATER,   ITEM_SPLASH_PLATE, ABILITY_PALLETE_SWAP},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ULMIRAINT_FIRE,   ITEM_FLAME_PLATE, ABILITY_PALLETE_SWAP},
    {FORM_CHANGE_TERMINATOR},
};
