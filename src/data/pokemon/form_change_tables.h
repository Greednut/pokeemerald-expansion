...
static const struct FormChange sUlmiraintFormChangeTable[] = {
    ...
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ULMIRAINT_STEEL,   ITEM_IRON_PLATE, ABILITY_PALLETE_SWAP},
    ...
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ULMIRAINT_GHOST,   ITEM_SPOOKY_PLATE, ABILITY_PALLETE_SWAP},
    ...
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ULMIRAINT_FAIRY,   ITEM_PIXIE_PLATE, ABILITY_PALLETE_SWAP},
    ...
    {FORM_CHANGE_ITEM_HOLD, SPECIES_ULMIRAINT_BUG,   ITEM_INSECT_PLATE, ABILITY_PALLETE_SWAP},
...
static const struct FormChange sShiribikoFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_BEFORE_MOVE_CATEGORY, SPECIES_SHIRIBIKO_PLAYING,  DAMAGE_CATEGORY_PHYSICAL, ABILITY_ULTRAPOSITION},
    {FORM_CHANGE_BATTLE_BEFORE_MOVE,          SPECIES_SHIRIBIKO_ULTRA, MOVE_QUANTUM_POUNCE,        ABILITY_ULTRAPOSITION},
...
static const struct FormChange sPolybrawnFormChangeTable[] = {
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_POLYBRAWN,       ITEM_ROTOM_CATALOG, 0},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_POLYBRAWN_H,  ITEM_ROTOM_CATALOG, 1},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_POLYBRAWN_W,  ITEM_ROTOM_CATALOG, 2},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_POLYBRAWN_P, ITEM_ROTOM_CATALOG, 3},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_POLYBRAWN_I,   ITEM_ROTOM_CATALOG, 4},
    {FORM_CHANGE_ITEM_USE_MULTICHOICE, SPECIES_POLYBRAWN_K,   ITEM_ROTOM_CATALOG, 5},
   // {FORM_CHANGE_TERMINATOR},
};
#undef WHEN_LEARNED
