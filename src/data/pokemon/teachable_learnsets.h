...
static const u16 sSaccestodaTeachableLearnset[] = { 
    MOVE_SUPER_FANG,
    MOVE_HYPER_FANG,
    MOVE_LUNAR_IMPACT,
    MOVE_OMINOUS_WIND,
    ...
    MOVE_ALLY_SWITCH,
    MOVE_TRICK,
    MOVE_CORROSIVE_GAS, //Sounds Inofensive considering sticky tongue
    MOVE_SIMPLE_BEAM,
    MOVE_SWAGGER,
    MOVE_ECHOED_VOICE,
    MOVE_BRAIN_DAMAGE,
    MOVE_HEX, 
    MOVE_PURGE, //Shyguy asked for both this and hex
    MOVE_TOXIC,
    MOVE_HIDDEN_POWER,
    MOVE_TAUNT,
    MOVE_HYPER_BEAM,
...
static const u16 sGlucursTeachableLearnset[] = { 
    ...
    MOVE_SNATCH,
    MOVE_POISON_JAB,
    MOVE_ENERGY_BALL, // to discuss further potentially
    MOVE_DAZZLING_GLEAM,
    MOVE_SUBSTITUTE,
    MOVE_HONE_CLAWS,
    MOVE_WORK_UP,
