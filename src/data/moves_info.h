...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_RAPID_SPIN] =
    {
        ...
        .description = COMPOUND_STRING(
            "Spinning attack that removes hazards\n"
            "and raises the user's Speed."),
    ...
    [MOVE_DEFOG] =
    {
        ...
        .description = COMPOUND_STRING(
            "Removes hazards and other field\n"
            "effects and lowers evasion."),
        .effect = EFFECT_DEFOG,
        .power = 0,
        .type = TYPE_FLYING,
        .accuracy = 0,
    ...
    [MOVE_GEOMANCY] =
    {
        ...
        .description = COMPOUND_STRING(
            "Charges for a turn, then\n"
            "sharply raisse Sp. Atk,\n"
            "Sp. Def and Speed."),
    ...
    [MOVE_POWER_UP_PUNCH] =
    {
        ...
        .description = COMPOUND_STRING(
            "A punch that toughens the user.\n"
            "Always raises user's Attack."),
        .effect = EFFECT_HIT,
        .power = 50,
        .type = TYPE_FIGHTING,
        .accuracy = 100,
    ...
    [MOVE_LANDS_WRATH] =
    {
        ...
        .description = COMPOUND_STRING(
            "An earthly attack that suppresses\n"
            "the abilities of all foes hit."),
        .effect = EFFECT_HIT,
        .power = 90,
        .type = TYPE_GROUND,
        .accuracy = 100,
    ...
    [MOVE_FIRST_IMPRESSION] =
    {
        ...
        .description = COMPOUND_STRING(
            "Hits hard before other priority.\n"
    ...
    [MOVE_PHOTON_GEYSER] =
    {
        ...
        .description = COMPOUND_STRING(
            "The move category matches the\n"
            "user's higher offensive stat.\n"
            "Ignores abilities."),
    ...
    [MOVE_ROCKET_PUNCH] =
    {
        ...
        .description = COMPOUND_STRING(
            "A punch that hits before other\n"
    ...
    {
        .name = COMPOUND_STRING("Voltaic Cyclone"),
        .description = COMPOUND_STRING(
            "Whips up an electric storm that\n"
            "frees the user of hazards."),
        .effect = EFFECT_RAPID_SPIN,
        .power = 75,
        .type = TYPE_ELECTRIC,
        .accuracy = 100,
    ...
    [MOVE_PETRIFY] =
    {
        ...
        .description = COMPOUND_STRING(
            "Protects the user from damaging\n"
            "moves and raises their Defense."),
        .effect = EFFECT_PROTECT, 
        .power = 0,
        .type = TYPE_ROCK,
        .accuracy = 0,
    ...
    [MOVE_FAEBLADE] =
    {
        ...
        .description = COMPOUND_STRING(
            "A soul-cutting blade that targets\n"
            "the foe's Sp. Def."),
    ...
    [MOVE_BOIL_OVER] =
    {
        ...
        .description = COMPOUND_STRING(
            "A weather-dependant attack.\n"
            "Fire-type in Rain and Water-type\n"
            "in Sun, but doubles in power."),
    ...
    [MOVE_CRUSADER_CRASH] =
    {
        ...
        .description = COMPOUND_STRING(
            "A flurry of punches followed by\n"
            "a proud shout. Always crits."),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_FIGHTING,
        .accuracy = 100,
    ...
    [MOVE_SHADOW_SCALES] =
    {
        ...
        .description = COMPOUND_STRING(
            "Enshrouds the target with\n"
            "dark scales. Lowers the\n"
            "user's Defense."),
        .effect = EFFECT_HIT,
        .power = 110,
        .type = TYPE_GHOST,
    ...
    [MOVE_GAZER_BEAM] =
    {
        ...
        .description = COMPOUND_STRING(
            "A searing ray of light that is\n"
            "super-effective on Steel-types.\n"
            "This may inflict a burn."),
        .effect = EFFECT_SUPER_EFFECTIVE_ON_ARG,
        .power = 70,
        .type = TYPE_STEEL,
        .accuracy = 100,
    ...
    [MOVE_BRANDING_BLADE] =
    {
        ...
        .contestComboStarterId = 0,
        .contestComboMoves = {0},
        .battleAnimScript = Move_BRANDING_BLADE,
    },
    ...
    [MOVE_MUD_MAELSTROM] =
    {
        ...
        .description = COMPOUND_STRING(
            "The target is swamped with mud\n"
            "which damages them over time.\n"),
        .effect = EFFECT_HIT,
        .power = 100,
        .type = TYPE_GROUND,
        .accuracy = 80,
    ...
    [MOVE_CALIBRATE] =
    {
        ...
        .description = COMPOUND_STRING(
            "The user focuses their aim to\n"
            "raise Sp. Atk. and accuracy."),
    ...
    [MOVE_CHILI_POWDER] =
    {
        ...
        .description = COMPOUND_STRING(
            "Scatters spicy powder on\n"
            "the foe to burn them."),
        .effect = EFFECT_NON_VOLATILE_STATUS,
        .power = 0,
        .type = TYPE_FIRE,
        .accuracy = 100,
    ...
    [MOVE_EARTH_SHATTER] =
    {
        ...
        .description = COMPOUND_STRING(
            "The ground ruptures with such\n"
            "force the user is harmed as well."),
        .effect = EFFECT_RECOIL,
        .power = 120,
        .type = TYPE_GROUND,
        .accuracy = 100,
    ...
    [MOVE_EXTINCTION] =
    {
        ...
        .description = COMPOUND_STRING(
            "The foe is instantly KO'd with\n"
            "a comedically slow meteor."),
        .effect = EFFECT_OHKO,
        .power = 1,
        .type = TYPE_DRAGON,
        .accuracy = 30,
    ...
    [MOVE_SWORDBREAKER] = // 1000 folds (this note is for search ease! please keep it here -rex)
    {
        ...
        .description = COMPOUND_STRING(
            "A powerful slice that lowers\n"
            "the user's Attack. Neutral\n"
            "against Steel-types."),
    ...
    [MOVE_SHINE_STRIKE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Shining feathers hit the\n"
            "foe 2 to 5 times. Neutral\n"
            "against Steel-types."),
    ...
    [MOVE_FLAK_CANNON] =
    {
        ...
        .description = COMPOUND_STRING(
            "Destroys the user's held item to\n"
            "fire the shards. Always crits."),
    ...
    [MOVE_TRICK_STAB] =
    {
        ...
        .description = COMPOUND_STRING(
            "A stab that always results in\n"
            "a critical hit under Illusion."),
    ...
    [MOVE_MOP] =
    {
        ...
        .description = COMPOUND_STRING(
            "Frees user from hazards. If any were\n"
            "removed, raises their accuracy."),
        .effect = EFFECT_MOP,
        .power = 0,
        .type = TYPE_FAIRY,
        .accuracy = 0,
    ...
    [MOVE_DEAD_SILENCE] =
    {
        .name = COMPOUND_STRING("Dead Silence"),
        .description = COMPOUND_STRING(
            "Inflicts Perish Song\n"
            "on Hit."),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_GHOST,
